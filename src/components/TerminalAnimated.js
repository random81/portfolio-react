...
const TerminalAnimated = (props) => {
  ...
  function terminalAnimation() {
    ...
    // we might be able to evaluate refUnmounted by setting it true, so that if
    // it runs again on update, and evaluates to true
    ...
    function timer() {
      ...
      if (oneCharacter === ',') {
        ...
        characterIterator += 1;
        return x;
        // you are returning x to make sure that the new value still exists in the next time
